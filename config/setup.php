...
$db = new PDO($DB_DSN, $DB_USER, $DB_PASSWORD, array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
    ...
    echo "Failure to connect with the servor! the mistake comes from: ".$e;
}
...
try{
    ...
    echo "Fail to create the database! the mistake comes from: ".$e;
}
...
try{
    ...
    echo "ERROR. The mistake comes from: ".$e;
}
