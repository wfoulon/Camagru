            ...
            <div class="form-content">
                ...
                <form align="center" method="POST" action="" class="form">
                    ...
                    <div class="item">New password</div>
                        <input style="text-align:center;" class="input" type="password" name="newpassword" required />
                    <br>
                    <div class="item">Confimation</div>
                        <input style="text-align:center;" class="input" type="password" name="confirmnewpassword" required/>
                    <br>
                    <div align="center">
